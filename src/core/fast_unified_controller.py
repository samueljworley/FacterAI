"""
FastUnifiedController: Optimized for speed with minimal latency
"""
import asyncio
import time
from typing import Dict, List, Any
from .optimized_retrieval_service import optimized_retrieval_service
...
class FastUnifiedController:
    """Fast controller optimized for sub-200ms retrieval"""
    
    def __init__(self):
        self.retrieval_service = optimized_retrieval_service
    ...
    async def process_query(self, query: str, query_type: str = "research") -> Dict[str, Any]:
        ...
        """
        try:
            # Step 1: Fast retrieval (target: <200ms)
            context = await self.retrieval_service.retrieve(query, size=12)
...
# Global instance
fast_unified_controller = FastUnifiedController()
