"""
Corrected query parser that properly handles compositional queries
"""
import re
...
class CorrectedQueryParser:
    """Corrected parser that properly handles compositional queries"""
...
# Global instance
corrected_query_parser = CorrectedQueryParser()
