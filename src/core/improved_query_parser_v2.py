"""
Improved query parser v2 that handles more query patterns
"""
import re
...
class ImprovedQueryParserV2:
    """Improved parser v2 that handles more query patterns"""
    ...
    def __init__(self):
        ...
        self.compositional_patterns = [
            ...
            # "does X increase/decrease Y" - must have clear X and Y
...
# Global instance
improved_query_parser_v2 = ImprovedQueryParserV2()
