"""
Improved query parser that better handles single-entity queries
"""
import re
...
class ImprovedQueryParser:
    """Improved parser that better distinguishes single-entity vs compositional queries"""
    ...
    def __init__(self):
        ...
        # Compositional query patterns - more specific
        ...
        self.single_entity_indicators = [
            r'what\s+is\s+the\s+effect\s+of\s+',
            r'how\s+does\s+',
            r'what\s+are\s+the\s+effects\s+of\s+',
            r'does\s+.*\s+impair\s+',
            r'does\s+.*\s+improve\s+',
            r'does\s+.*\s+increase\s+',
            r'does\s+.*\s+decrease\s+',
...
# Global instance
improved_query_parser = ImprovedQueryParser()
